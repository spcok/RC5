...
export const createStandardCollection = (tableName: string) => {
  return createCollection(
    queryCollectionOptions({
      ...
      onUpdate: async (id: string, draft: unknown) => {
...
export const animalsCollection = createStandardCollection('animals');
...
// 3. Tasks Collection
export const tasksCollection = createStandardCollection('tasks');
